...
blurb: Scraping, indexing, and recolouring the Rider-Waite tarot deck.
year: 2026
order: 2
...
demo:
  - kind: images
    caption: Finally, the script snaps every pixel from the original image to its nearest palette entry by Euclidean LAB distance.
    items:
      - { src: /assets/rider-waite/ace_of_cups-in.png, alt: Ace of Cups — original }
      - { src: /assets/rider-waite/ace_of_cups-out.png, alt: Ace of Cups — recoloured }
      - { src: /assets/rider-waite/the_empress-in.png, alt: The Empress — original }
      - { src: /assets/rider-waite/the_empress-out.png, alt: The Empress — recoloured }
...
The generated cards are used in an oracle tarot reader — interactive embed
forthcoming.
